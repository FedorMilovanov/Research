# TEEN_DOUBLE_LIFE — Research Corpus Index
...
Do not let psychology/developmental theory become the controlling anthropology.

## Architecture

Core adolescent series remains:

1. Part I — hidden life;
2. Part II — parents;
3. Part III — church.

Research-layer architecture for the adult/family-government material is **resolved** by `237`, reconciled by `239`:

4. Companion A — adult child in rebellion: departure, contact, waiting, repentance and return;
5. Companion B — house, money and consequences;
...
## Late continuity / Product transfer
...
Parallel agents are active. Duplicate numeric prefixes and high-numbered gap modules are legitimate.

**Exact filename, not numeric prefix, identifies a module.**

Before every write:

- re-fetch live PR/branch head;
