...
| **2026** | Tarte au Citron historiography | Relais Desserts professional synthesis explicitly challenges a simplistic timeless-native-French modern-tart genealogy and points toward older transnational/English lemon-cream leads | `PROFESSIONAL LOCATOR/FALSIFICATION SOURCE`; underlying chain is now materially grounded by Acton 1845 / Webster 1855 / Jeanes 1870 / Gérard 1877, while French codification into the mature modern form remains open |
...
- Tarte au Citron `Jacques Genin invented the genre`: false/unsafe. 2009 concerns a modern authored citron-basilic version.
- Tarte au Citron `shell + lemon filling first appears only in late nineteenth-century France`: false as current corpus wording; Acton's 1845 English text already maps lemon tartlets baked in thin puff-paste shells.
...
4. Tarte au Citron: visually inspect Acton 1845 printed p.431/p.434 in the institutional/public-domain scan; acquire direct Genin 2009 participant evidence; complete Dumas 1873 bounded lemon-entry review; inspect Jeanes 1870 p.227; locate earliest directly inspectable comparable French professional shell+lemon recipe and meringue/emulsified-cream transitions.
