...
| **1845** | Tarte au Citron component/architecture genealogy | Acton, *Modern Cookery*: first-edition-based text maps `Common Lemon Tartlets` p.431 and a cooked `Store Mixture for Lemon Tartlets` p.434; both use thin puff-paste shells with lemon/egg/sugar/butter filling, while Wellcome/Leeds independently verifies an 1845 digitized 679-image object and Public Domain Mark | `STRONG EDITION-MAPPED ARCHITECTURE + INSTITUTIONAL FULL-OBJECT CUSTODY / EXACT p.431+p.434 FACSIMILE LEAVES STILL PAGE_IMAGE_HOLD`; not French-origin or invention proof — https://wellcomecollection.org/works/rdz664vd |
...
| **1870** | Tarte au Citron component genealogy | William Jeanes, *Gunter's Modern Confectioner*, 3rd ed.; professional TOC directly lists `Lemon Cheese Cakes`, p.227 | `DIRECT PROFESSIONAL NAMED ENTRY / EXACT RECIPE PAGE STILL OPEN`; professional transmission target, no longer needed to establish the mere existence of shell+lemon filling — https://books.google.com/books?id=VjoCAAAAQAAJ |
...
- Tarte au Citron `shell + lemon filling first appears only in late nineteenth-century France`: false as current corpus wording; Acton's 1845 English text already maps lemon tartlets baked in thin puff-paste shells and the form is visible in U.S. print by 1850.
- Tarte au Citron `Acton 1845 exact recipe facsimile is already directly inspected`: false; institutional 1845 object/rights and edition-mapped text are strong, but p.431/p.434 scan leaves remain open.
...
4. Tarte au Citron: visually inspect Acton 1845 printed p.431/p.434 in the institutional/public-domain scan; seek a Genin-controlled **2009 date** source only; complete Dumas 1873 bounded lemon-entry review; inspect Jeanes 1870 p.227; locate earliest directly inspectable comparable French professional shell+lemon recipe and meringue/emulsified-cream transitions.
