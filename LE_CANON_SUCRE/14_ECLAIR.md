...
Когда `éclair` фиксируется именно как pâtisserie; как он связан с `pains à la duchesse`; можно ли доказать популярную атрибуцию Carême; насколько быстро название выходит за пределы Франции?
...
Google Books full-object record:
https://books.google.com/books/about/Le_Patissier_moderne_ou_trait%C3%A9_%C3%A9l%C3%A9men.html?id=BljqJaHy8eoC

Louis Bailleux, *Le Pâtissier moderne ou Traité élémentaire et pratique de la pâtisserie française au dix-neuvième siècle*, Paris, 1856, 267 pp.

Google Books identifies the original as British Library and the digitized object as a 1856 edition.

Christie's first-edition bibliographic description records Bailleux's dedication to his master M. A. Cintract of Maison Frascati:
https://www.christies.com/en/lot/lot-6415317

Specialist historical-language research gives the exact printed locator **`Éclairs`, p. 74** and describes coffee/chocolate cream plus matching icing variants:
https://wordhistories.net/2025/03/25/eclair-cake/

Current evidence state:

- 1856 Bailleux book identity = `FULL_OBJECT_VERIFIED` at bibliographic/digitized-object level;
- p. 74 `Éclairs` = `TIGHT SECONDARY LOCATOR TO PRIMARY`;
- direct page image/content through the primary scan = still `LOCATOR_HOLD`;
- direct quotation from p. 74 = not approved until page inspection.

A second specialist culinary-history article independently describes Bailleux's 1856 éclair dimensions/cream/icing family, useful for triangulation but still secondary:
https://jamieschler.substack.com/p/leclair-part-one

## Early American transmission — 1861
...
The archive object identifies *Vanity Fair* volume 3 as a New York 1861 periodical and marks the digitized volume as public domain / no known U.S. copyright restriction in the archive metadata. The current crawler timed out on direct page navigation, so the exact p. 50 column has **not** yet been inspected there.

Evidence decision:

- 1861 volume identity/archive object = `A2 INSTITUTIONAL OBJECT IDENTIFIED`;
- exact 2 Feb 1861 p. 50 col. 1 locator = `TIGHT SECONDARY LOCATOR`;
- exact page inspection = `LOCATOR_HOLD`;
- safe bounded inference: the French pastry name was circulating in American English by 1861 if the primary page confirms the locator;
- unsafe inference: a proved France→New York commercial route or first U.S. bakery sale.

## Historical primary evidence — Gouffé 1873

Pâte à choux family:
https://fr.wikisource.org/wiki/Page%3AGouff%C3%A9_-_Le_Livre_de_P%C3%A2tisserie%2C_1873.djvu/121
...
Wave 2 still has **no exact Carême page** saying that Carême invented the éclair or transformed a duchesse into the named pastry.
...
> Antonin Carême invented the éclair.
...
Gouffé 1873 documented family:

`pâte à choux → duchesse/éclair related forms → filling/glazing variants`.
