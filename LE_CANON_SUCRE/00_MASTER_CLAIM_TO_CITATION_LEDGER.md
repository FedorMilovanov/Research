...
| LCS-TC09 | https://books.google.com/books?id=dDQEAAAAYAAJ | A1 | FULL_HISTORICAL_OBJECT_VERIFIED | FULL_OBJECT_IDENTITY_VERIFIED / EXACT_LEMON_ENTRIES_OPEN | GOOGLE_BOOKS_ITEM_REVIEW | REFERENCE | Alexandre Dumas, *Grand dictionnaire de cuisine*, Alphonse Lemerre, 1873 full object; exact lemon-entry audit remains open, so search/common-term snippets are not promoted into recipe claims |
...
- Wikisource/Commons historical scans/transcriptions: reuse conditions must be checked per scan/transcription page; preserve credits. This now includes Gérard 1877 `tourte au citron` before any facsimile Product use.
...
5. Tarte au Citron: direct Genin participant source; exact Dumas 1873 lemon entries; Jeanes 1870 p.227; earlier English lemon-cream/lemon-cheese chain; pre/post-1877 French named-form chain; earliest directly inspectable recognizable shell + lemon filling and meringue transition;
