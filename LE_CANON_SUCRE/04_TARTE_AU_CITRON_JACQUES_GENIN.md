# 04 — Tarte au Citron / Jacques Genin

## Проверяемый вопрос

Как отделить историю жанра tarte au citron от конкретного современного языка Jacques Genin; когда во французской pâtisserie появляется именно сочетание baked tart shell + lemon cream/curd; что документируется о Genin citron-basilic и его технике крема?
...
### Authorized author/source custody — Alternatives 2010

Official publisher archive, Éditions Alternatives:
https://www.editionsalternatives.com/site.php?id=991&type=P

The publisher identifies **Jacques Genin and Ingrid Astier** as authors of *Le meilleur de la tarte au citron*, collection `Un tour en cuisine`, published **14 October 2010**, ISBN **978-2-86227-651-9**. The publisher explicitly frames the book as Genin opening his kitchen and transmitting his methods for the tart dough, its baking and the lemon cream, with photographed gestures and multiple variations.

This materially closes a previously open modern-source lane:

- by **2010** there is an **authorized publisher-held author book** devoted specifically to Genin's lemon-tart technique and variations;
- this is stronger for `GENIN TECHNIQUE / AUTHORED INTERPRETATION` than relying only on later press recipes or copied web versions;
- the book is copyrighted. Its identity and scope are evidence; its pages/photographs are not a free Product asset and should not be reproduced without permission/custody;
- the publisher page does **not** state that the citron-basilic version was created in 2009, so it does not independently close that exact year.

A 2010 reporter who says she interviewed Genin and spent hours in his workshop also records his tart method and announces the same two books. This is useful direct-participant/observational corroboration but remains independent journalism rather than the authorized source of record:
https://www.sofoodsogood.com/2010/09/12/5719/

### 2009 creation-year evidence — still independent, not participant-closed

Le Monde, 2021:
https://www.lemonde.fr/le-monde-passe-a-table/article/2021/06/29/on-s-y-presse-notre-selection-des-15-meilleures-tartes-au-citron_6086237_6082232.html

The article identifies Genin's citron-basilic tart, dates that version to **2009**, and describes a pâte sucrée with a lime-basil creamy filling. It emphasizes reduced sugar and clean aromatic expression.

Le Monde's contemporaneous April **2009** profile independently verifies that Genin had just opened the rue de Turenne space and records his stated philosophy of transmission/variation rather than self-mythologizing as a creator of flavors:
https://www.lemonde.fr/vous/article/2009/04/03/jacques-genin-et-sa-chocolaterie_1176278_3238.html

This improves context but still does not explicitly date the citron-basilic tart itself. Therefore:

- `GENIN AUTHORIZED TECHNIQUE SOURCE BY 2010` = **CLOSED**;
- `CITRON-BASILIC CREATED IN 2009` = **PROBABLE / STRONG B1**, not participant-primary-closed.

Additional independent modern sources:

Le Monde profile:
https://www.lemonde.fr/m-styles/article/2014/12/18/toque-de-chocolat_4543389_4497319.html

Le Monde modern-classic context:
https://www.lemonde.fr/m-le-mag/article/2014/10/24/chic-un-dessert_4511148_4500055.html

Fooding recipe/method witness:
https://lefooding.com/recettes/toquera-101-la-tarte-au-citron

This is useful for technique but should not be reproduced wholesale. Copyright recipe text is not a production asset.

## Genre-history falsification lead — Relais Desserts 2026

Relais Desserts professional association:
https://www.relais-desserts.net/2026/01/19/il-etait-une-fois-la-tarte-au-citron/
...
Google Books full historical object:
https://books.google.com/books?id=b28EAAAAYAAJ

Mrs. A. L. Webster, *The Improved Housewife: Or Book of Receipts, with Engravings for Marketing and Carving*, 20th ed., Phillips, Sampson, **1855**, p.141.

The digitized page exposes a recipe explicitly headed **`Lemon Cream`**. The preparation uses lemon peel/juice, eggs and sugar and is heated while stirred until it thickens, then cooled. It is served as a cream rather than documented there as a tart filling.
...
Google Books historical object:
https://books.google.com/books?id=VjoCAAAAQAAJ

William Jeanes, *Gunter's Modern Confectioner*, 3rd ed., Dean & Son, **1870**. The digitized table of contents directly lists **`Lemon Cheese Cakes`**, p.227.
...
In an inventory explicitly discussing `les tartes ... et les tourtes`, Gérard directly lists **`la tourte au citron`** among Alsatian pastry forms.
...
> Jacques Genin invented the tarte au citron.

Do write, with attribution:

> In modern Parisian pâtisserie, Genin's citron-basilic version became a distinctive reinterpretation built around acidity, a lemon-basil cream and a separately baked tart shell; later journalism dates that version to 2009, while an authorized Genin/Astier book documents his lemon-tart technique by 2010.
...
- **2009 rue de Turenne opening context** = independently documented contemporaneously by Le Monde.
...
- whether a Genin-controlled 2009 source can close the exact creation year for citron-basilic.
...
- **2009** — Le Monde later dates Genin citron-basilic version to this year; contemporaneous Le Monde independently confirms the new rue de Turenne house context but not the tart's exact creation year;
- **2010-10-14** — authorized publisher record for Genin/Astier, *Le meilleur de la tarte au citron*, closes author-source custody for his lemon-tart technique and variations;
...
- citrus cream;
- acid/sugar balance;
- variations on lemon-tart architecture;
- independent recipe/reporting further documents basil and butter-emulsion technique.

Do not flatten these into one unchanged recipe tradition.

## Sensory markers

Supported modern markers: pronounced acidity, aromatic purity, restrained sweetness, unusually fluid cream texture.

## Typical failures — research hypotheses only

Future technical sources should test: over-sweetening, overcooked/curdled cream, weak citrus aroma, thick rubbery texture, soggy shell. These are not yet source-closed claims.
...
`PUBLICATION_HOLD` remains on the **origin/French-convergence** section. The `GENIN TECHNIQUE/AUTHOR SOURCE` lane is no longer open at object-identity level; only exact 2009 creation-year custody remains.
