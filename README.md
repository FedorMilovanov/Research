...
Article 8 XLIII и XLIV не являются текущими читательскими версиями: для публикации используется чистая XLVI. Статья 7 XLIII сохраняется как базовый текст, но раздел Иуд. 6–7 заменяется XLVI publication overlay. При конфликте любого старого writing packet с XLIV–XLVI применяется новый тематический owner и authority overlay XLVI.
