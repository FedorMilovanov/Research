# РУССКИЕ БАПТИСТЫ — архив и точка восстановления
...
Долговременные текстовые копии состояния находятся в каталоге [`RUSSIAN_BAPTISTS_ARCHIVE/`](RUSSIAN_BAPTISTS_ARCHIVE/README.md).

## Правило хранения

- PDF, DJVU, ZIP и исходные экспорты хранятся в Google Drive.
- GitHub хранит библиографию, Drive ID, ссылки, контроль конфликтов, статусы, правила дедупликации и следующие действия.
