# G3 HISTORY — media / photo ledger

**Status:** ACTIVE / RIGHTS_HOLD by default  
**Rule:** discovery of a public image does not authorize copying it into this public repository or republishing it in the final article.

| ID | Subject / scene | Source / owner context | Historical use | Rights state | Action |
|---|---|---|---|---|---|
| G3-M001 | Large G3 conference audience / preacher from stage | Crossmap-hosted conference-photo page; image CDN currently visible in search | illustrate scale / conference era | RIGHTS_UNKNOWN | identify photographer/original event/year before use; do not copy binary |
| G3-M002 | Scott Aniol speaking behind G3-branded podium | Christian Post article on 2025 presidential appointment | leadership transition after Buice | PERMISSION_REQUIRED | preserve source link; seek CP/license or alternative official G3 still |
| G3-M003 | Josh Buice preaching at G3 conference | Baptist News Global article on May 2025 scandal; article photo/screencap | founder / 2025 crisis | PERMISSION_REQUIRED | preserve article credit; seek original/video still rights if publication needed |
| G3-M004 | G3 fellowship/worship crowd, 2024 registration media | G3/Webconnex registration asset | operational scale immediately before 2025 crisis | RIGHTS_UNKNOWN | strongest candidate for institution-owned publicity asset; verify terms/photographer |
| G3-M005 | G3 Expository Workshop — Psalms promotional graphic, Apr 22–23 2026 at Pray’s Mill | G3 event registration/Webconnex asset | demonstrates PMBC/G3 integration and 2026 pre-crisis activity | RIGHTS_UNKNOWN | screenshot/reference only until publication basis established |
...
For every image promoted from this ledger, record:
...
- copyright owner;
- event/date shown;
- whether image was editorial, publicity/press-kit, Creative Commons, public domain, licensed or permission-granted;
