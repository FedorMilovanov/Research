...
What happened to the economically and editorially meaningful assets of G3 after the announced 2026 wind-down—especially G3 Press, G3+, book rights, inventory, subscriber relationships, trademarks/domains and content libraries?
...
- remaining printed inventory;
- digital audiobook/e-book rights;
- G3+ streaming license;
...
Possible; subscriber wording is compatible with acquisition. Price/recipient unknown.
...
Possible, especially for G3+/software/content operations. No contract acquired.
