...
Постиховый audit показывает локальные cruxes. Но слабая модель иногда хорошо объясняет один стих и плохо — всю перикопу. Поэтому здесь проверяются **целостные модели** по одному и тому же набору требований.

Это не арифметическое голосование и не pseudo-scientific score.

### Labels

- `NATURAL` — узел объясняется моделью без дополнительной специальной гипотезы.
- `COMPATIBLE` — узел совместим, но не является сильным подтверждением модели.
- `EXTRA_ASSUMPTION` — для сохранения модели нужен дополнительный шаг, не выраженный прямо.
- `TENSION` — текст создаёт заметное давление против модели.
- `MAJOR_TENSION` — модель должна существенно переописать/перестроить текст.
- `N/A` — модель не предназначена решать этот узел.
...
### M3 — Hair/hairstyle-only

No separate textile veil:
- vv.4–6 concern hair state/arrangement;
- vv.14–15 reveal what earlier covering language meant;
- variants include loose/unbound hair, conventional styling, gender-coded length.

### M4 — Roman ritual/status trigger

Not a complete semantic model but a historical explanatory model:
- male `κατὰ κεφαλῆς ἔχων` linked to Roman `capite velato` cult/status practice;
- female covering/status read in Roman-colony visual/social context.

Oster/Gill/Finney family.
...
Substantial vv.4–9 (or similar span) represent Corinthian position/quotation, with Paul correcting it later. Peppiatt and recent quotation-identification proposals represent forms of this family.

### M7 — Interpolation / non-Pauline major block

Major portion or whole 11:2–16 is secondary/non-Pauline. Walker/Mount-type proposals represent the edge family; Murphy-O'Connor later argued against Walker's version.
...
| v16 churches/custom closure | NATURAL | NATURAL | COMPATIBLE | COMPATIBLE | COMPATIBLE | TENSION depending what exactly church custom closes | removed |
| early manuscript presence of pericope | NATURAL | NATURAL | NATURAL | NATURAL | NATURAL | NATURAL | MAJOR_TENSION: no omission-base sufficient for removal |
| early material-covering reception | NATURAL | NATURAL | TENSION | COMPATIBLE | COMPATIBLE | TENSION if most passage is opposite speaker | TENSION |
...
- Gives vv.14–15 maximum integrative force.
- Can make the whole passage about visible sex differentiation without requiring a separate garment.
- Some ancient cultic/social sources show hair arrangement could matter strongly.
...
**C serious alternative**, not refuted, but weaker as a whole-pericope model than M1/M2.
...
- Corinth is a Roman colony; Roman male covered worship is directly historically attested.
- Gill/Oster make v.4 less culturally opaque.
- Finney-style status reading helps explain why dress could become an ecclesial conflict.

### Limits

- Historical context does not interpret `κεφαλή`, `ἐξουσία`, angels, vv.11–12, or `φύσις` by itself.
...
- Can explain perceived tensions between vv.3–9 and vv.10–12 by assigning them different voices.
- Makes woman's authority/mutuality the Pauline corrective.
- Rhetorical quotation is real elsewhere in 1 Corinthians, so category itself is not absurd.

### Major burdens

- No quotation marks in ancient text and no decisive explicit speaker-change marker at the necessary boundary.
- `διὰ τοῦτο` v.10 naturally connects to preceding material, which is harder if Paul is rejecting it.
- `πλὴν` v.11 already supplies a natural internal qualification without needing speaker replacement.
- Early interpretation did not preserve awareness of such a large quotation.

### Overall

**D/C-low**. Worth mapping and testing, not publication co-equal alternative without stronger discourse evidence.

---

## M7 — Interpolation/non-Pauline block

### Apparent explanatory benefit

- Removes theological tensions with other Pauline texts by removing the difficult passage.

### Fatal/major burdens

- No adequate manuscript omission-base for 11:2–16 or 11:3b–15.
- Solves exegetical difficulty by textual excision rather than explaining transmitted text.
- Murphy-O'Connor's later chapter specifically argues against Walker's non-Pauline thesis.
- Coherence problems do not equal textual evidence.

### Overall

**D/C-low edge model**. Keep for history of scholarship; do not treat as live textual-critical rival absent new manuscript evidence.

---

# 5. What survives strongest adversarial pressure

The matrix does **not** prove M1 by counting `NATURAL` cells. It shows where explanatory burdens accumulate.
...
# 6. Sources anchoring model families

- Massey textile lexical case: https://www.cambridge.org/core/journals/new-testament-studies/article/abs/meaning-of-and-in-1-corinthians-11216/3B94F4462B2AC39852FE16FBECD46E38
- Watson interdependence/material veil: https://www.cambridge.org/core/journals/new-testament-studies/article/abs/authority-of-the-voice-a-theological-reading-of-1-cor-11216/FABA54ECB3573BAE1579923E51D409C1
- Hooker exousia: https://www.cambridge.org/core/journals/new-testament-studies/article/abs/authority-on-her-head-an-examination-of-i-cor-xi-10/947E8A98C64ACEA00D2BD815F0F8BDE5
- Newberry vv.7–12: https://www.cambridge.org/core/journals/new-testament-studies/article/abs/pauls-allusive-reasoning-in-1-corinthians-11712/EDE6D54A62D2265EA2C22291B6F2BA39
- Gill Roman portraiture: https://www.tyndalebulletin.org/article/30525-the-importance-of-roman-portraiture-for-head-coverings-in-1-corinthians-11-2-16
- Callon wives/free(d)-wives: https://www.cambridge.org/core/journals/harvard-theological-review/article/authority-over-whose-head-did-paul-instruct-wives-or-all-women-to-cover-their-heads-1-corinthians-11216/5D602D820F9CA0E6C55906BDF68466ED
- Murphy-O'Connor hairstyle/human messengers: https://academic.oup.com/book/8618/chapter/154575789 and https://academic.oup.com/book/8618/chapter/154574352
- Murphy-O'Connor critique of interpolation: https://academic.oup.com/book/8618/chapter/154572123
- Peppiatt rhetorical model index: https://www.jstor.org/stable/j.ctvz0hc8w

## Boundary

```text
MODEL_MATRIX = RESEARCH TOOL
MODEL_MATRIX != VOTE
MODEL_MATRIX != UI
PRODUCT_WRITE = false
