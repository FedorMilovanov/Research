...
**Дата:** 9 августа 2026 (обновлено после слияния параллельного фундамента)
**Статус:** `BRANCH-OPEN / PUSHED / ANTI-DUPLICATION / SINGLE-DOSSIER-OWNER / FOUNDATION-MERGED / GREEK-DOSSIER-06-WRITTEN`
**Ветка:** `arena/019fe62b-research`
**Scope:** новый исследовательский кейс `1КОРИНФЯНАМ_11_ПОКРЫВАЛО`
**Канонический entrypoint:** `00_README_FOUNDATION_OPEN_2026-08-09.md`
...
Внутри этой ветки два параллельных агента независимо заложили фундамент (см. `00A_PARALLEL_FOUNDATION_MERGE_NOTE_2026-08-09.md`). Фундаменты слиты в одну каноническую папку (см. ниже).
