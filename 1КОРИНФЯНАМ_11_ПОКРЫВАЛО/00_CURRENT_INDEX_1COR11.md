...
- `dossiers/MANUAL_READING_ACCESS_CHECKLIST.md` — complete list of unread direct bodies/pages/images/datasets, exact locators, access routes, reading order and return protocol.

```text
CURRENT_RESEARCH_AUDIT_READY = true
MANUAL_READING_CHECKLIST != ACTIVE_AGENT_ACQUISITION_QUEUE
USER_PROVIDED_PDF_SCAN_OR_BOOK_ACCESS = REOPEN_ONLY_MATCHING_CHECKLIST_ITEM
```
...
- `dossiers/MANUAL_READING_ACCESS_CHECKLIST.md` — 43 concrete unread-body/page/image/dataset items with exact locators and reading order.
...
DRAKE_2025_CH2_PP70_89 = OFFICIAL_CUP_SUMMARY_CLOSED / FULL_BODY_TERMINAL_PUBLISHER_ACCESS_HOLD
...
Every previously active high-value target is now classified as one of:
...
```text
ACTIVE_ACQUISITION_QUEUE_FOR_CURRENT_KNOWN_ROUTES = EMPTY
AUDIT_QUEUE_DISPOSITION = COMPLETE
MANUAL_READING_ACCESS_CHECKLIST = COMPLETE_FOR_CURRENT_KNOWN_GAPS
NEW_AUTHORIZED_INSTITUTIONAL_OR_RENDERABLE_SOURCE_ROUTE = REOPEN_ONLY_TRIGGER
