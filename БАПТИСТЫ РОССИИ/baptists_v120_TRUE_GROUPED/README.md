...
## v127-v128 update — OCR из канала Синичкина: 5 quote_ready строк (0→5 за сессию)

**v127:** Инструктивное письмо 1960 (10 стр.) + Владикавказ 1885 (13 стр.) — OCR tesseract rus. См. `groups/08_..._OCR.md`.

**v128:** 2-й съезд ЕС 1910-11 (23 стр.) + Братский вестник 1945 №2 (44 стр.) — OCR tesseract rus. См. `groups/09_CONGRESS_EC_1911_AND_BRATSKY_VESTNIK_1945_OCR.md`.

**Итог по quote_ready (5 строк, было 0):** (1) Вестник спасения 1965 №3; (2) Инструктивное письмо ВСЕХБ 1960; (3) Владикавказ 1885; (4) 2-й съезд ЕС 1910-11; (5) Братский вестник 1945 №2.

**Levindanto identity resolved:** Н.А. Левинданто — член совета ВСЕХБ 1945 (подпись в телеграмме Сталину).
...
## v131 — «Братский листок» Telegram recovery audit

- Все 15 oversized attachment-блоков в `messages4.html` / `messages5.html` проверены на уровне сырого HTML.
- Зафиксировано: 0 attachment href, 0 скрытых media-атрибутов, 0 путей `files/...`, 0 Telegram file ID/access hash.
- Канонический recovery-ledger: [`../../RUSSIAN_BAPTISTS_ARCHIVE/bratsky_listok_telegram_missing_15_recovery_2026-07-31.csv`](../../RUSSIAN_BAPTISTS_ARCHIVE/bratsky_listok_telegram_missing_15_recovery_2026-07-31.csv).
- Рабочая инструкция: [`../../RUSSIAN_BAPTISTS_ARCHIVE/TELEGRAM_REEXPORT_BRATSKY_LISTOK_15_INSTRUCTION_2026-07-31.md`](../../RUSSIAN_BAPTISTS_ARCHIVE/TELEGRAM_REEXPORT_BRATSKY_LISTOK_15_INSTRUCTION_2026-07-31.md).
- Корректные маршруты: repeat export выше 12,4 MB с Files, owner resend или проверенный parent extraction.
- Бинарное покрытие и `MASTER_CORPUS_LEDGER.csv` не изменены; metadata не повышает статус до local/quote-ready.
