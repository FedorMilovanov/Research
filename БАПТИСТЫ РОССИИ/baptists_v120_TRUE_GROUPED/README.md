...
## v127 update — OCR из канала Синичкина: Инструктивное письмо 1960 + Владикавказ 1885 (3-я и 4-я quote_ready строки)

**Источник:** Google Drive архив «СИНИЧКИН БАПТИСТ КАНАЛ.zip» (1.2 ГБ, 6125 файлов) — предоставлен владельцем. Скачан и распакован в workspace.

**Прорыв:** первое полноценное OCR-извлечение из канала Синичкина. Цикл: PDF → pdftoppm (250-300 DPI) → tesseract rus → quote-cards. Предыдущий агент (v125) сделал OCR, но не сохранил тексты; теперь OCR-тексты сохранены и процитированы.

**Повышены до `quote_ready`:**
1. **Инструктивное письмо ВСЕХБ 1960** (10 стр., OCR 300 DPI) — «smoking gun» раскола 1961. 6 quote-cards: запрет на привлечение новых членов («главной задачей... является НЕ привлечение новых членов»); «нездоровые миссионерские проявления»; испытательный срок 2-3 года; запрет крещения молодёжи; запрет домашних собраний; контроль богослужения (2-3 собрания/неделю, проповедь только исполнительного органа, запрет гитар); правовая основа = Постановление 1929 г.
2. **Съезд во Владикавказе 1885** (13 стр., OCR 250 DPI, старая орфография) — первый русский баптистский съезд. 3 quote-cards: «первая самостоятельная русская конференция» (Каргель, Фетлер); немецко-русское партнёрство в миссии; «союз мира».

**Triangulation:** Инструктивное письмо 1960 (голос ВСЕХБ: «НЕ привлечение новых членов») ↔ Вестник спасения 1965 №3 (голос СЦ ЕХБ: «богопротивных человеческих постановления») — классическая sources-triangulation по протоколу 02.

**PROOF_STATUS_LEDGER.csv:** теперь 3 строки `quote_ready` (было 1 в v126, 0 в начале сессии). См. `groups/08_INSTRUCTIONAL_LETTER_1960_AND_VLADIKAVKAZ_1885_OCR.md`.

**Roadmap:** 2-й съезд ЕС 1911 (распакован, OCR TODO); Братский Вестник 1945 №2 (распакован); ~300 выпусков «Баптистъ» 1909-1927 (page_count_verified_scan_no_ocr — кандидаты на массовый OCR).
